...
class JobMatch:
    ...
    def jobmatch_page_tab(page):
        ...
        job_details = [get_job_details(i) for i in page]
        ...
        # Attach page URLs
        job_details['URL'] = [_get_job_link(i) for i in page]
    ...
    def compile_jobs_dataframe(self):
        ...
        for page_url in tqdm(saved_pages_urls, desc='Process'):
            ...
            frames.append(jobmatch_page_tab(job_page))
